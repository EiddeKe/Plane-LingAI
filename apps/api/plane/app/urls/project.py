...
from plane.app.views import (
    ...
    ProjectPendingMembersEndpoint,
    ProjectMemberApprovalEndpoint,
)
...
urlpatterns = [
    ...
    path(
        "workspaces/<str:slug>/projects/<uuid:project_id>/pending-members/",
        ProjectPendingMembersEndpoint.as_view(),
        name="project-pending-members",
    ),
    path(
        "workspaces/<str:slug>/projects/<uuid:project_id>/members/<uuid:pk>/approve/",
        ProjectMemberApprovalEndpoint.as_view(),
        name="project-member-approval",
    ),
]
