...
export const ProjectAccessRestriction = observer(function ProjectAccessRestriction(props: TProps) {
  const { isWorkspaceAdmin, handleJoinProject, isJoinButtonDisabled, isPendingApproval, errorStatusCode } = props;
  // plane hooks
    ...
    return (
      <div className="grid h-full w-full place-items-center bg-surface-1">
        <EmptyStateDetailed
          ...
          description={t("project_empty_state.no_access.pending_approval")}
          assetKey="no-access"
