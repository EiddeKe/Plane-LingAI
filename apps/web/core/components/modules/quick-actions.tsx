...
export const ModuleQuickActions = observer(function ModuleQuickActions(props: Props) {
  ...
  const isDeletionAllowed = allowPermissions(
  ...
  const isModuleCreator = moduleDetails?.created_by === currentUser?.id;
  const canDelete = isModuleCreator || isDeletionAllowed;
